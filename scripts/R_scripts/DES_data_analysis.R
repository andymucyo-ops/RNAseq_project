...
# WT
sig_genes_WT <- rownames(res_WT)[filtering_criteria][order(res_WT$padj[
  filtering_criteria
])]
...
sig_genes_DKO <- rownames(res_DKO)[filtering_criteria][order(res_DKO$padj[
  filtering_criteria
])]
...
# DKO vs WT
sig_genes_DKOvsWT_case <- rownames(res_DKOvsWT_case)[
  filtering_criteria
][order(res_DKOvsWT_case$padj[filtering_criteria])]
